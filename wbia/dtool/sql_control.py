...
class SQLDatabaseController(object):
    ...
    def connect(self):
        ...
        lite.register_adapters(
            self._connection.dialect.dbapi.register_adapter,
            self._connection.dialect.dbapi.register_converter,
        )
    ...
    def _create_connection(self):
        # Remove sqlite:/// from self.uri
        path = self.uri[len('sqlite:///') :]
        if not exists(path):
        ...
        lite.register_adapters(
            connection.dialect.dbapi.register_adapter,
            connection.dialect.dbapi.register_converter,
        )
    ...
    def reboot(self):
        ...
        lite.register_adapters(
            ...
            self.connection.dialect.dbapi.register_converter,
        )
